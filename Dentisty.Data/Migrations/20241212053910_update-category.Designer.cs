...
namespace Dentisty.Data.Migrations
{
    ...
    [Migration("20241212053910_update-category")]
            ...
            modelBuilder.Entity("Dentistry.Data.GeneratorDB.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "ff6e0353-a5ef-4493-9f58-b520b74be7a9",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEOQUaQo2funXcEGgNsvsUXMg3TxpiAgPOdIi3eIE8x9OYLL/fb0zAlz0quI0bgvhcA==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "14dc25c5-295e-43f2-a216-83f797cf6280",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEF1XBKC0UwsU6+a45SVaNigxbnmVDqYpEWSFHVywNigF4peKUN7BMnPZTKL/baLNuQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("Dentistry.Data.GeneratorDB.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 12, 12, 12, 39, 10, 107, DateTimeKind.Local).AddTicks(1546),
            ...
            modelBuilder.Entity("Dentistry.Data.GeneratorDB.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Alias = "rang-su",
                            CreatedDate = new DateTime(2024, 12, 12, 12, 39, 10, 107, DateTimeKind.Local).AddTicks(1481),
                            IsActive = true,
                            Name = "Răng Sứ",
                            Sort = 0,
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 2,
                            Alias = "nieng-rang",
                            CreatedDate = new DateTime(2024, 12, 12, 12, 39, 10, 107, DateTimeKind.Local).AddTicks(1495),
                            IsActive = true,
                            Name = "Niềng Răng",
                            Sort = 0,
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 3,
                            Alias = "benh-ly",
                            CreatedDate = new DateTime(2024, 12, 12, 12, 39, 10, 107, DateTimeKind.Local).AddTicks(1497),
                            IsActive = true,
                            Name = "Bệnh lý",
                            Sort = 0,
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 4,
                            Alias = "gioi-thieu",
                            CreatedDate = new DateTime(2024, 12, 12, 12, 39, 10, 107, DateTimeKind.Local).AddTicks(1498),
                            IsActive = true,
                            Name = "Giới thiệu",
                            Sort = 0,
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 5,
                            Alias = "lien-he",
                            CreatedDate = new DateTime(2024, 12, 12, 12, 39, 10, 107, DateTimeKind.Local).AddTicks(1500),
                            IsActive = true,
                            Name = "Liên hệ",
                            Sort = 0,
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 12, 12, 12, 39, 10, 107, DateTimeKind.Local).AddTicks(1502),
                            IsActive = true,
