...
namespace Dentisty.Data.Migrations
{
    ...
    [Migration("20250320140147_add-ThumbImage")]
    partial class addThumbImage
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Dentistry.Data.GeneratorDB.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "6ceaf034-24ca-463c-9329-a66f5bde497e",
                            DisplayName = "Nhiên",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEMvp6ihuVB9DR6IYT0N7L61PQ9sXpdAvqMgFQWohCzogYXuyF3vFIL4cIhC0LZ10WA==",
            ...
            modelBuilder.Entity("Dentistry.Data.GeneratorDB.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Alias = "dich-vu",
                            CreatedDate = new DateTime(2025, 3, 20, 21, 1, 46, 34, DateTimeKind.Local).AddTicks(3854),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Dịch vụ",
                        ...
                        new
                        {
                            Id = 2,
                            Alias = "san-pham",
                            CreatedDate = new DateTime(2025, 3, 20, 21, 1, 46, 34, DateTimeKind.Local).AddTicks(3877),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Sản phẩm",
                        ...
                        new
                        {
                            Id = 3,
                            Alias = "kien-thuc",
                            CreatedDate = new DateTime(2025, 3, 20, 21, 1, 46, 34, DateTimeKind.Local).AddTicks(3882),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Kiến thức",
                        ...
                        new
                        {
                            Id = 4,
                            Alias = "tin-tuc",
                            CreatedDate = new DateTime(2025, 3, 20, 21, 1, 46, 34, DateTimeKind.Local).AddTicks(3885),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Tin tức",
                        ...
                        new
                        {
                            Id = 5,
                            Alias = "tu-van",
                            CreatedDate = new DateTime(2025, 3, 20, 21, 1, 46, 34, DateTimeKind.Local).AddTicks(3888),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Tư vấn",
                        ...
                        new
                        {
                            Id = 6,
                            Alias = "lien-he",
                            CreatedDate = new DateTime(2025, 3, 20, 21, 1, 46, 34, DateTimeKind.Local).AddTicks(3892),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Liên hệ",
                        ...
                        new
                        {
                            Id = 7,
                            Alias = "gioi-thieu",
                            CreatedDate = new DateTime(2025, 3, 20, 21, 1, 46, 34, DateTimeKind.Local).AddTicks(3896),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Giới thiệu",
