...
namespace Dentisty.Data.Migrations
{
    ...
    [Migration("20260725111741_AddTrackVisitorLocation")]
    partial class AddTrackVisitorLocation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Dentistry.Data.GeneratorDB.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "07c29aff-e505-47cb-b6dc-bcaac58b72e7",
                            DisplayName = "Nhiên",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAENEr0rFe+NnTZcjJQ7K1Oks9mkPGIk9IxbpO63n3ngl/J67sFUzUlWzjtkcLn8Oyow==",
            ...
            modelBuilder.Entity("Dentistry.Data.GeneratorDB.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Alias = "dich-vu",
                            CreatedDate = new DateTime(2026, 7, 25, 18, 17, 40, 813, DateTimeKind.Local).AddTicks(6646),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Dịch vụ",
                        ...
                        new
                        {
                            Id = 2,
                            Alias = "san-pham",
                            CreatedDate = new DateTime(2026, 7, 25, 18, 17, 40, 813, DateTimeKind.Local).AddTicks(6678),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Sản phẩm",
                        ...
                        new
                        {
                            Id = 3,
                            Alias = "kien-thuc",
                            CreatedDate = new DateTime(2026, 7, 25, 18, 17, 40, 813, DateTimeKind.Local).AddTicks(6686),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Kiến thức",
                        ...
                        new
                        {
                            Id = 4,
                            Alias = "tin-tuc",
                            CreatedDate = new DateTime(2026, 7, 25, 18, 17, 40, 813, DateTimeKind.Local).AddTicks(6693),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Tin tức",
                        ...
                        new
                        {
                            Id = 5,
                            Alias = "tu-van",
                            CreatedDate = new DateTime(2026, 7, 25, 18, 17, 40, 813, DateTimeKind.Local).AddTicks(6696),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Tư vấn",
                        ...
                        new
                        {
                            Id = 6,
                            Alias = "lien-he",
                            CreatedDate = new DateTime(2026, 7, 25, 18, 17, 40, 813, DateTimeKind.Local).AddTicks(6700),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Liên hệ",
                        ...
                        new
                        {
                            Id = 7,
                            Alias = "gioi-thieu",
                            CreatedDate = new DateTime(2026, 7, 25, 18, 17, 40, 813, DateTimeKind.Local).AddTicks(6706),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Giới thiệu",
