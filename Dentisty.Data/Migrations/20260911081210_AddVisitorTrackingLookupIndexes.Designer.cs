...
namespace Dentisty.Data.Migrations
{
    ...
    [Migration("20260911081210_AddVisitorTrackingLookupIndexes")]
    partial class AddVisitorTrackingLookupIndexes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Dentistry.Data.GeneratorDB.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "71c6440e-fbdf-4c64-894d-71e78d1b28d0",
                            DisplayName = "Nhiên",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEM3C0lw6P/hEpIBEnjnwF5Lw/eBO7tt7FC2NBRKhgR7DSiWlpwrK8JK1zXgUv60XVw==",
            ...
            modelBuilder.Entity("Dentistry.Data.GeneratorDB.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Alias = "dich-vu",
                            CreatedDate = new DateTime(2026, 9, 11, 15, 12, 10, 231, DateTimeKind.Local).AddTicks(2823),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Dịch vụ",
                        ...
                        new
                        {
                            Id = 2,
                            Alias = "san-pham",
                            CreatedDate = new DateTime(2026, 9, 11, 15, 12, 10, 231, DateTimeKind.Local).AddTicks(2855),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Sản phẩm",
                        ...
                        new
                        {
                            Id = 3,
                            Alias = "kien-thuc",
                            CreatedDate = new DateTime(2026, 9, 11, 15, 12, 10, 231, DateTimeKind.Local).AddTicks(2860),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Kiến thức",
                        ...
                        new
                        {
                            Id = 4,
                            Alias = "tin-tuc",
                            CreatedDate = new DateTime(2026, 9, 11, 15, 12, 10, 231, DateTimeKind.Local).AddTicks(2864),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Tin tức",
                        ...
                        new
                        {
                            Id = 5,
                            Alias = "tu-van",
                            CreatedDate = new DateTime(2026, 9, 11, 15, 12, 10, 231, DateTimeKind.Local).AddTicks(2868),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Tư vấn",
                        ...
                        new
                        {
                            Id = 6,
                            Alias = "lien-he",
                            CreatedDate = new DateTime(2026, 9, 11, 15, 12, 10, 231, DateTimeKind.Local).AddTicks(2872),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Liên hệ",
                        ...
                        new
                        {
                            Id = 7,
                            Alias = "gioi-thieu",
                            CreatedDate = new DateTime(2026, 9, 11, 15, 12, 10, 231, DateTimeKind.Local).AddTicks(2875),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Giới thiệu",
