...
namespace Dentisty.Data.Migrations
{
    ...
    [Migration("20260821045018_AddAppSettingHomeSeoFields")]
    partial class AddAppSettingHomeSeoFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Dentistry.Data.GeneratorDB.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "ceb37cf3-d883-4eaf-85be-c4b53c3bb2d1",
                            DisplayName = "Nhiên",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEF8FprKiZXQQr86kvVCVMt5H4VJSftH/oFvZ7gCVMNsAt1mWQrsQB5uLgf3MXZOENQ==",
            ...
            modelBuilder.Entity("Dentistry.Data.GeneratorDB.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Alias = "dich-vu",
                            CreatedDate = new DateTime(2026, 8, 21, 11, 50, 17, 245, DateTimeKind.Local).AddTicks(7940),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Dịch vụ",
                        ...
                        new
                        {
                            Id = 2,
                            Alias = "san-pham",
                            CreatedDate = new DateTime(2026, 8, 21, 11, 50, 17, 245, DateTimeKind.Local).AddTicks(7965),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Sản phẩm",
                        ...
                        new
                        {
                            Id = 3,
                            Alias = "kien-thuc",
                            CreatedDate = new DateTime(2026, 8, 21, 11, 50, 17, 245, DateTimeKind.Local).AddTicks(7971),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Kiến thức",
                        ...
                        new
                        {
                            Id = 4,
                            Alias = "tin-tuc",
                            CreatedDate = new DateTime(2026, 8, 21, 11, 50, 17, 245, DateTimeKind.Local).AddTicks(7977),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Tin tức",
                        ...
                        new
                        {
                            Id = 5,
                            Alias = "tu-van",
                            CreatedDate = new DateTime(2026, 8, 21, 11, 50, 17, 245, DateTimeKind.Local).AddTicks(7982),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Tư vấn",
                        ...
                        new
                        {
                            Id = 6,
                            Alias = "lien-he",
                            CreatedDate = new DateTime(2026, 8, 21, 11, 50, 17, 245, DateTimeKind.Local).AddTicks(7987),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Liên hệ",
                        ...
                        new
                        {
                            Id = 7,
                            Alias = "gioi-thieu",
                            CreatedDate = new DateTime(2026, 8, 21, 11, 50, 17, 245, DateTimeKind.Local).AddTicks(7992),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Giới thiệu",
