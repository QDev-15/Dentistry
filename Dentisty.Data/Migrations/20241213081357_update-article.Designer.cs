...
namespace Dentisty.Data.Migrations
{
    ...
    [Migration("20241213081357_update-article")]
            ...
            modelBuilder.Entity("Dentistry.Data.GeneratorDB.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "1e73a657-62ab-45a6-b7d4-7f673c13b828",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEHTToiweyjSbuWtvbkjgq7pWmO2vbO3y+YZtyk6GphnTmC/8GBlRtxbPUZKTxYI/Ow==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "5d2c0f66-570c-437d-8093-ee78c79f3fa2",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEM9dTowlCMyYXUuAfKCrQ5CYfL0qFCn93sy/OONunp9jR0g/EgrC9wAVe5DpGl3HSw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("Dentistry.Data.GeneratorDB.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 12, 13, 15, 13, 57, 321, DateTimeKind.Local).AddTicks(3940),
            ...
            modelBuilder.Entity("Dentistry.Data.GeneratorDB.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Alias = "rang-su",
                            CreatedDate = new DateTime(2024, 12, 13, 15, 13, 57, 321, DateTimeKind.Local).AddTicks(3881),
                            IsActive = true,
                            Name = "Răng Sứ",
                            Sort = 1,
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 2,
                            Alias = "nieng-rang",
                            CreatedDate = new DateTime(2024, 12, 13, 15, 13, 57, 321, DateTimeKind.Local).AddTicks(3892),
                            IsActive = true,
                            Name = "Niềng Răng",
                            Sort = 2,
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 3,
                            Alias = "benh-ly",
                            CreatedDate = new DateTime(2024, 12, 13, 15, 13, 57, 321, DateTimeKind.Local).AddTicks(3894),
                            IsActive = true,
                            Name = "Bệnh lý",
                            Sort = 3,
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 4,
                            Alias = "gioi-thieu",
                            CreatedDate = new DateTime(2024, 12, 13, 15, 13, 57, 321, DateTimeKind.Local).AddTicks(3895),
                            IsActive = true,
                            Name = "Giới thiệu",
                            Sort = 4,
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 5,
                            Alias = "lien-he",
                            CreatedDate = new DateTime(2024, 12, 13, 15, 13, 57, 321, DateTimeKind.Local).AddTicks(3897),
                            IsActive = true,
                            Name = "Liên hệ",
                            Sort = 5,
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 12, 13, 15, 13, 57, 321, DateTimeKind.Local).AddTicks(3899),
                            IsActive = true,
