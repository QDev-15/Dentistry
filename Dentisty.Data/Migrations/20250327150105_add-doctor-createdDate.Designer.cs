...
namespace Dentisty.Data.Migrations
{
    ...
    [Migration("20250327150105_add-doctor-createdDate")]
    partial class adddoctorcreatedDate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Dentistry.Data.GeneratorDB.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "6732446e-89f6-4c22-8299-8ae54055d648",
                            DisplayName = "Nhiên",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAELoMPLGj0RenYEPw78+C+fBCntdt1CgA9cVm1C68MOK7c3qeLiPNTY6RuYpQoTY0wA==",
            ...
            modelBuilder.Entity("Dentistry.Data.GeneratorDB.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Alias = "dich-vu",
                            CreatedDate = new DateTime(2025, 3, 27, 22, 1, 3, 821, DateTimeKind.Local).AddTicks(5196),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Dịch vụ",
                        ...
                        new
                        {
                            Id = 2,
                            Alias = "san-pham",
                            CreatedDate = new DateTime(2025, 3, 27, 22, 1, 3, 821, DateTimeKind.Local).AddTicks(5219),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Sản phẩm",
                        ...
                        new
                        {
                            Id = 3,
                            Alias = "kien-thuc",
                            CreatedDate = new DateTime(2025, 3, 27, 22, 1, 3, 821, DateTimeKind.Local).AddTicks(5224),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Kiến thức",
                        ...
                        new
                        {
                            Id = 4,
                            Alias = "tin-tuc",
                            CreatedDate = new DateTime(2025, 3, 27, 22, 1, 3, 821, DateTimeKind.Local).AddTicks(5227),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Tin tức",
                        ...
                        new
                        {
                            Id = 5,
                            Alias = "tu-van",
                            CreatedDate = new DateTime(2025, 3, 27, 22, 1, 3, 821, DateTimeKind.Local).AddTicks(5231),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Tư vấn",
                        ...
                        new
                        {
                            Id = 6,
                            Alias = "lien-he",
                            CreatedDate = new DateTime(2025, 3, 27, 22, 1, 3, 821, DateTimeKind.Local).AddTicks(5235),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Liên hệ",
                        ...
                        new
                        {
                            Id = 7,
                            Alias = "gioi-thieu",
                            CreatedDate = new DateTime(2025, 3, 27, 22, 1, 3, 821, DateTimeKind.Local).AddTicks(5238),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Giới thiệu",
