...
namespace Dentisty.Data.Migrations
{
    ...
    [Migration("20260911043356_AddSmtpSettingsToAppSetting")]
    partial class AddSmtpSettingsToAppSetting
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Dentistry.Data.GeneratorDB.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "62e044d5-42f8-45fd-902d-e11279861514",
                            DisplayName = "Nhiên",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEGC3mVldt65KVm5b/9/wNzLHpYN93PpI42LZ3HbJPp5x3P0vPfpld0mhw4pTvhNbMQ==",
            ...
            modelBuilder.Entity("Dentistry.Data.GeneratorDB.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Alias = "dich-vu",
                            CreatedDate = new DateTime(2026, 9, 11, 11, 33, 55, 719, DateTimeKind.Local).AddTicks(7876),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Dịch vụ",
                        ...
                        new
                        {
                            Id = 2,
                            Alias = "san-pham",
                            CreatedDate = new DateTime(2026, 9, 11, 11, 33, 55, 719, DateTimeKind.Local).AddTicks(7928),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Sản phẩm",
                        ...
                        new
                        {
                            Id = 3,
                            Alias = "kien-thuc",
                            CreatedDate = new DateTime(2026, 9, 11, 11, 33, 55, 719, DateTimeKind.Local).AddTicks(7933),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Kiến thức",
                        ...
                        new
                        {
                            Id = 4,
                            Alias = "tin-tuc",
                            CreatedDate = new DateTime(2026, 9, 11, 11, 33, 55, 719, DateTimeKind.Local).AddTicks(7937),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Tin tức",
                        ...
                        new
                        {
                            Id = 5,
                            Alias = "tu-van",
                            CreatedDate = new DateTime(2026, 9, 11, 11, 33, 55, 719, DateTimeKind.Local).AddTicks(7941),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Tư vấn",
                        ...
                        new
                        {
                            Id = 6,
                            Alias = "lien-he",
                            CreatedDate = new DateTime(2026, 9, 11, 11, 33, 55, 719, DateTimeKind.Local).AddTicks(7945),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Liên hệ",
                        ...
                        new
                        {
                            Id = 7,
                            Alias = "gioi-thieu",
                            CreatedDate = new DateTime(2026, 9, 11, 11, 33, 55, 719, DateTimeKind.Local).AddTicks(7949),
                            IsActive = true,
                            IsParent = true,
                            Level = 0,
                            Name = "Giới thiệu",
