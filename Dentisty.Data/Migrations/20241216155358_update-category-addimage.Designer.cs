...
namespace Dentisty.Data.Migrations
{
    ...
    [Migration("20241216155358_update-category-addimage")]
    partial class updatecategoryaddimage
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Dentistry.Data.GeneratorDB.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "d41305b8-c11e-4b74-a565-b167d08b7a31",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEFs6+h7l+jdvyej0mJAqNzyqAWg7EAinKQBQ/H013qv944SwRR0mTz407CdNYK8SWw==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "732130c0-2b02-4438-b040-c5b4715255ab",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEBkO+J/Bardx9kSSxrLtR1RjMFJ4S+NhokM1RyQBZmi4l1Az4OPMiCJIZdFXtNky2g==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("Dentistry.Data.GeneratorDB.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 12, 16, 22, 53, 57, 313, DateTimeKind.Local).AddTicks(1234),
            ...
            modelBuilder.Entity("Dentistry.Data.GeneratorDB.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Alias = "rang-su",
                            CreatedDate = new DateTime(2024, 12, 16, 22, 53, 57, 313, DateTimeKind.Local).AddTicks(1002),
                            IsActive = true,
                            Name = "Răng Sứ",
                            Sort = 1,
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 2,
                            Alias = "nieng-rang",
                            CreatedDate = new DateTime(2024, 12, 16, 22, 53, 57, 313, DateTimeKind.Local).AddTicks(1023),
                            IsActive = true,
                            Name = "Niềng Răng",
                            Sort = 2,
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 3,
                            Alias = "benh-ly",
                            CreatedDate = new DateTime(2024, 12, 16, 22, 53, 57, 313, DateTimeKind.Local).AddTicks(1026),
                            IsActive = true,
                            Name = "Bệnh lý",
                            Sort = 3,
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 4,
                            Alias = "gioi-thieu",
                            CreatedDate = new DateTime(2024, 12, 16, 22, 53, 57, 313, DateTimeKind.Local).AddTicks(1028),
                            IsActive = true,
                            Name = "Giới thiệu",
                            Sort = 4,
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 5,
                            Alias = "lien-he",
                            CreatedDate = new DateTime(2024, 12, 16, 22, 53, 57, 313, DateTimeKind.Local).AddTicks(1030),
                            IsActive = true,
                            Name = "Liên hệ",
                            Sort = 5,
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 12, 16, 22, 53, 57, 313, DateTimeKind.Local).AddTicks(1033),
                            IsActive = true,
