...
namespace Dentisty.Data.Migrations
{
    ...
    [Migration("20241215153455_update-article-isdraft")]
    partial class updatearticleisdraft
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Dentistry.Data.GeneratorDB.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "0a778ab6-e941-4b7a-98d3-8383157e4866",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEHwNKpS2+8hB/QMZjsFDyRtijHExq9YEXTdjjNDyoUIwDuee15/+8kUpQ2eMqhlzRA==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "eb6635c7-fc35-47e1-a2db-c13e2f146674",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEBsmmQSdZJ51pn5xJY9kA9Hr5CtkybVYEkBwGPI9h1ZZtmiiI6gAFRMKo3Y9WJQXyg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("Dentistry.Data.GeneratorDB.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 12, 15, 22, 34, 54, 159, DateTimeKind.Local).AddTicks(7636),
            ...
            modelBuilder.Entity("Dentistry.Data.GeneratorDB.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Alias = "rang-su",
                            CreatedDate = new DateTime(2024, 12, 15, 22, 34, 54, 159, DateTimeKind.Local).AddTicks(7425),
                            IsActive = true,
                            Name = "Răng Sứ",
                            Sort = 1,
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 2,
                            Alias = "nieng-rang",
                            CreatedDate = new DateTime(2024, 12, 15, 22, 34, 54, 159, DateTimeKind.Local).AddTicks(7447),
                            IsActive = true,
                            Name = "Niềng Răng",
                            Sort = 2,
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 3,
                            Alias = "benh-ly",
                            CreatedDate = new DateTime(2024, 12, 15, 22, 34, 54, 159, DateTimeKind.Local).AddTicks(7450),
                            IsActive = true,
                            Name = "Bệnh lý",
                            Sort = 3,
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 4,
                            Alias = "gioi-thieu",
                            CreatedDate = new DateTime(2024, 12, 15, 22, 34, 54, 159, DateTimeKind.Local).AddTicks(7453),
                            IsActive = true,
                            Name = "Giới thiệu",
                            Sort = 4,
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 5,
                            Alias = "lien-he",
                            CreatedDate = new DateTime(2024, 12, 15, 22, 34, 54, 159, DateTimeKind.Local).AddTicks(7456),
                            IsActive = true,
                            Name = "Liên hệ",
                            Sort = 5,
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 12, 15, 22, 34, 54, 159, DateTimeKind.Local).AddTicks(7459),
                            IsActive = true,
