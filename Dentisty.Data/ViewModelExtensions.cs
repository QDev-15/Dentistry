    ...
    public static class ViewModelExtensions
    {
        ...
        public static AppSettingVm ReturnViewModel(this AppSetting item)
        {
            ...
            var model = new AppSettingVm()
            {
                Id = item.Id,
                Name = item.Name,
                Facebook1 = item.Facebook1,
                Facebook2 = item.Facebook2, 
                Facebook3 = item.Facebook3,
                Hotline1 = item.Hotline1,
                Hotline2 = item.Hotline2,   
                Hotline3 = item.Hotline3,
                Hotline4 = item.Hotline4,
                Instagram1 = item.Instagram1,
                Instagram2 = item.Instagram2,
                Instagram3 = item.Instagram3,   
                Twitter1 = item.Twitter1,
                Twitter2 = item.Twitter2,   
                Twitter3 = item.Twitter3,
                Zalo1 = item.Zalo1,
                Zalo2 = item.Zalo2,
                Zalo3 = item.Zalo3,
                Zalo4 = item.Zalo4
